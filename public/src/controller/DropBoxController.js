...
//define um nome para o elemento                    //id do button enviar
        this.btnSendFileEl = document.querySelector('#btn-send-file')
        this.inputFilesEl = document.querySelector('#files')//id do input
        this.snackModalEl = document.querySelector('#react-snackbar-root')//id do ícone de progresso do download
    ...
    connectFirebase(){
      ...
      // Initialize Firebase
      var config = {
        apiKey: "AIzaSyBJO8Xj6BXjFcaR1GQSBaxDGQizlEvq6eE",
        authDomain: "drop-ccef3.firebaseapp.com",
        databaseURL: "https://drop-ccef3.firebaseio.com",
        projectId: "drop-ccef3",
        storageBucket: "drop-ccef3.appspot.com",
        messagingSenderId: "962895369117"
      };
    ...
    removeFolderTask(ref, name){
        ...
        return new Promise((resolve, reject)=>{
            ...
            folderRef.on('value', snapshot =>{
                //folderRef.off('value')//se der erro descomente
 ...
 //quando o objeto tem ífens, coloque entre aspas e chaves, exemplo ['input-files']

                //console.log(resp.files['input-file'])
                     //file    //push add o item  //set guarda os dados
    ...
    uploadComplete(){
        ...
        this.modalShow(false);
         ...
         //após download concluir ele start o objeto
    ...
    modalShow(show = true){
        //para mostrar barra de progresso via css
            ...
            let ajax = new XMLHttpRequest()
                ...
                ajax.upload.onprogress = onprogress
                   ...
                   onloadstart()
                    ...
                    //get o horário que inicia o download
    ...
    //método para listar os arquivos do bd
    readFiles(){
        ...
        this.getFirebaseRef().on('value' , snapshot =>{
            ...
            this.listFilesEl.innerHTML = '' //clear
...
//parentElement pega o pai  ul dos objetos li
//childNodes pega todos os  filhos li
